...
<head>
	...
	<script src="https://kit.fontawesome.com/39ae81062d.js" crossorigin="anonymous"></script>
</head>
<body>
						...
						<ul class="widget widget-menu unstyled">
							...
							<li>
								...
								<ul id="togglePages" class="collapse unstyled">
									...
									<li>
										<a href="halaman_admin.php?halaman=tambahproduk">
											<i class="icon-inbox"></i>
											Tambah produk
										</a>
									</li>
							...
							<li>
							<a href="halaman_admin.php?halaman=pembelian">
											<i class="icon-inbox"></i>
											Cek pembelian
										</a>
							</li>
				...
				<div class="span9">
					<div class="content">
						...
						<div class="">
							...
							<div class="module-head" style="background-color:rgb(248, 248, 255);">
							...
							<?php 
									...
									}elseif($_GET['halaman']=="detail_pembayaran"){
